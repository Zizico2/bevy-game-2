...
pub const CHESS_INITIAL_POSITION: [(Option<(Piece, Color)>, Square); 64] = [
    (Some((Piece::Rook, Color::White)), Square::A1),
    (Some((Piece::Knight, Color::White)), Square::B1),
    (Some((Piece::Bishop, Color::White)), Square::C1),
    (Some((Piece::Queen, Color::White)), Square::D1),
    (Some((Piece::King, Color::White)), Square::E1),
    (Some((Piece::Bishop, Color::White)), Square::F1),
    (Some((Piece::Knight, Color::White)), Square::G1),
    (Some((Piece::Rook, Color::White)), Square::H1),
    (Some((Piece::Pawn, Color::White)), Square::A2),
    (Some((Piece::Pawn, Color::White)), Square::B2),
    (Some((Piece::Pawn, Color::White)), Square::C2),
    (Some((Piece::Pawn, Color::White)), Square::D2),
    (Some((Piece::Pawn, Color::White)), Square::E2),
    (Some((Piece::Pawn, Color::White)), Square::F2),
    (Some((Piece::Pawn, Color::White)), Square::G2),
    (Some((Piece::Pawn, Color::White)), Square::H2),
    (None, Square::A3),
    (None, Square::B3),
    (None, Square::C3),
    (None, Square::D3),
    ...
    (None, Square::G6),
    (None, Square::H6),
    (Some((Piece::Pawn, Color::Black)), Square::A7),
    (Some((Piece::Pawn, Color::Black)), Square::B7),
    (Some((Piece::Pawn, Color::Black)), Square::C7),
    (Some((Piece::Pawn, Color::Black)), Square::D7),
    (Some((Piece::Pawn, Color::Black)), Square::E7),
    (Some((Piece::Pawn, Color::Black)), Square::F7),
    (Some((Piece::Pawn, Color::Black)), Square::G7),
    (Some((Piece::Pawn, Color::Black)), Square::H7),
    (Some((Piece::Rook, Color::Black)), Square::A8),
    (Some((Piece::Knight, Color::Black)), Square::B8),
    (Some((Piece::Bishop, Color::Black)), Square::C8),
    (Some((Piece::Queen, Color::Black)), Square::D8),
    (Some((Piece::King, Color::Black)), Square::E8),
    (Some((Piece::Bishop, Color::Black)), Square::F8),
    (Some((Piece::Knight, Color::Black)), Square::G8),
    (Some((Piece::Rook, Color::Black)), Square::H8),
];
